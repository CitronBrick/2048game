...
function Grid(props) {
  ...
  function handleKeyDown(evt) {
    if (['ArrowUp', 'ArrowRight', 'ArrowDown', 'ArrowLeft'].includes(evt.key)) {
      dispatch({
        dir: evt.key.substring(5)
      });
    }
  }

  React.useEffect(() => {
    // equivalent to componentDidMount, since dependancy array (2nd argument) is empty
...
function App() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h1", null, "2048 Game"), /*#__PURE__*/React.createElement("div", {
    className: "panel"
  }, /*#__PURE__*/React.createElement("span", null, "Score: ", /*#__PURE__*/React.createElement("span", {
    id: "score"
  }, score)), " ", /*#__PURE__*/React.createElement("button", {
    onClick: startNewGame
  }, "New Game")), /*#__PURE__*/React.createElement(Grid, {
    setScore: setScore,
    setResult: setResult
  }), /*#__PURE__*/React.createElement("output", null, result), /*#__PURE__*/React.createElement("p", null, "Use the arrow keys to move the squares & make 2048"));
}
